...
public class CarController : MonoBehaviour {
    ...
    void FixedUpdate() {
       ...
       ///Suspension force at position
        ...
        bLeftRear = Physics.Raycast(leftRear + 0.2f * transform.up, -transform.up, out hLeftRear, hoverHeight);
        bRightRear = Physics.Raycast(rightRear + 0.2f * transform.up, -transform.up, out hRightRear, hoverHeight);
        bLeftFront = Physics.Raycast(leftFront + 0.2f * transform.up, -transform.up, out hLeftFront, hoverHeight);
        bRightFront = Physics.Raycast(rightFront + 0.2f * transform.up, -transform.up, out hRightFront, hoverHeight);

        //Debug.LogWarning(bLeftRear + " " + bRightRear + " " + bLeftFront + "  " + bRightFront + " " + grounded);
